...
import at.reder.avrwb.core.io.DefaultMemoryChunk;
import at.reder.avrwb.core.io.IntelHexInputStream;
...
public class MemoryImplNGTest
{
  ...
  public static void setUpClass() throws Exception
  {
    ...
    assertNotNull("dataSpace==null", dataSpace);
  }
  ...
  public void testInitialize()
  {
    ...
    MemoryChunk chunk = new DefaultMemoryChunk(0, bb, bb.capacity());
    assertTrue(memory.initialize(chunk));
    bb = ByteBuffer.allocate(memory.getSize() + 1);
    chunk = new DefaultMemoryChunk(0, bb, bb.capacity());
  ...
  {
    assertEquals("data", memory.getId());
  }

  @Test
  public void testGetName()
  {
    assertEquals("data", memory.getName());
  }

  @Test
  public void testGetByteOrder()
  {
    assertEquals(ByteOrder.LITTLE_ENDIAN, memory.getByteOrder());
  }

  @Test
  public void testGetSize()
  {
    assertEquals(0x460, memory.getSize());
  }

  @Test
  public void testGetStart()
  {
    assertEquals(0, memory.getStart());
  }
  ...
  public void testReadCharactersUntilEOS_1()
  {
    ...
    int numCharacters = -1;
    int expResult = 14;
    int result = memory.readCharacters(address, buffer, offset, numCharacters, utf8);
    assertEquals(expResult, result);
    assertEquals("Reder Wolfgang", new String(buffer, 0, result));
  }
  ...
  public void testReadCharactersUntilEOS_2()
  {
    ...
    int result = memory.readCharacters(address, buffer, offset, numCharacters, utf8);
    assertEquals(expResult, result);
    assertEquals("Reder Wolfgang\nAustria", new String(buffer, 0, result));
  }
  ...
  public void testReadCharactersUntilEOS_3()
  {
    ...
    int result = memory.readCharacters(address, buffer, offset, numCharacters, utf8);
    assertEquals(expResult, result);
    assertEquals("R€der Wolfgang\nAustr", new String(buffer, 0, result));
  }
  ...
  public void testReadCharactersUntilLimit_1()
  {
    ...
    int result = memory.readCharacters(address, buffer, offset, numCharacters, utf8);
    assertEquals(expResult, result);
    assertEquals("R€der", new String(buffer, 0, result));
  }
  ...
  public void testReadCharactersUntilLimit_2()
  {
    ...
    memory.initialize(new DefaultMemoryChunk(0, bb, bb.capacity()));
    int address = 0;
    char[] buffer = new char[memory.getSize() + 2];
    int offset = 0;
    ...
    int result = memory.readCharacters(address, buffer, offset, numCharacters, utf8);
    assertEquals(expResult, result);
    assertEquals("R€der Wolfgang\0Austr", new String(buffer, 0, result));
  }
  ...
  public void testReadCharactersUntilLimit_3()
  {
    ...
    int result = memory.readCharacters(address, buffer, offset, numCharacters, utf8);
    assertEquals(expResult, result);
    assertEquals("R€der Wolfgang\0Austria\0\0\0", new String(buffer, 0, result));
  }
  ...
  public void testWriteCharacters_1()
  {
    ...
    int toWrite = -1;
    int expResult = 16;
    int result = memory.writeCharacters(address, str.toCharArray(), offset, toWrite, utf8);
    assertEquals(expResult, result);
    char[] buffer = new char[24];
    result = memory.readCharacters(address, buffer, offset, toWrite, utf8);
    expResult = 14;
    assertEquals(expResult, result);
    assertEquals("R€der Wolfgang", new String(buffer, 0, result));
  }
  ...
  public void testWriteCharacters_2()
  {
    ...
    expResult = 8;
    assertEquals(expResult, result);
    assertEquals("R€der Wo", new String(buffer, 0, result));
  }
  ...
  {
    int address = memory.getSize() - 10;
    memory.writeCharacters(address, "R€der Wolfgang".toCharArray(), 0, -1, utf8);
    StringBuilder str = memory.readString(address, utf8, 4);
    assertNotNull(str);
    assertEquals("R€der Wo", str.toString());
    address = 0;
    memory.writeCharacters(address, "R€der Wolfgang\0Austria".toCharArray(), 0, 22, utf8);
    str = memory.readString(address, utf8, 4);
    assertEquals("R€der Wolfgang", str.toString());
  }
  ...
  public void readString_2()
  {
    int address = memory.getSize() - 10;
    memory.writeCharacters(address, "R€der Wolfgang".toCharArray(), 0, -1, utf8);
    StringBuilder str = memory.readString(address, utf8, 1024);
    assertNotNull(str);
    assertEquals("R€der Wo", str.toString());
    address = 0;
    memory.writeCharacters(address, "R€der Wolfgang\0Austria".toCharArray(), 0, 22, utf8);
    str = memory.readString(address, utf8, 1024);
    assertEquals("R€der Wolfgang", str.toString());
  }
  ...
  public void testGetFloat() throws IOException
  {
    ...
    assertNotNull("eeprom==null", eeprom);
