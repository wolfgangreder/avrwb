...
import at.reder.avrwb.io.IntelHexOutputStream;
...
public class IntelHexInputStreamNGTest
{
  ...
  private void readCompare(URL url, int bufSize) throws IOException
  {
  ...
  {
    readCompare(IntelHexInputStream.class.getResource("/hexfiles/spi2uart.eep"), 16);
  }

  @Test
  public void test_spi2uarteep_10() throws IOException
  {
    readCompare(IntelHexInputStream.class.getResource("/hexfiles/spi2uart.eep"), 10);
  }

  @Test
  public void test_spi2uarteep_1() throws IOException
  {
    readCompare(IntelHexInputStream.class.getResource("/hexfiles/spi2uart.eep"), 1);
  }

  @Test
  public void test_spi2uarteep_17() throws IOException
  {
    readCompare(IntelHexInputStream.class.getResource("/hexfiles/spi2uart.eep"), 17);
  }

  @Test
  public void test_spi2uarteep_4096() throws IOException
  {
    readCompare(IntelHexInputStream.class.getResource("/hexfiles/spi2uart.eep"), 4096);
  }

  @Test
  public void test_spi2uarthex_16() throws IOException
  {
    readCompare(IntelHexInputStream.class.getResource("/hexfiles/spi2uart.hex"), 16);
  }
  ...
  {
    readCompare(IntelHexInputStream.class.getResource("/hexfiles/spi2uart.hex"), 10);
  }

  @Test
  public void test_spi2uarthex_1() throws IOException
  {
    readCompare(IntelHexInputStream.class.getResource("/hexfiles/spi2uart.hex"), 1);
  }

  @Test
  public void test_spi2uarthex_17() throws IOException
  {
    readCompare(IntelHexInputStream.class.getResource("/hexfiles/spi2uart.hex"), 17);
  }

  @Test
  public void test_spi2uarthex_4096() throws IOException
  {
    readCompare(IntelHexInputStream.class.getResource("/hexfiles/spi2uart.hex"), 4096);
  }

  @Test(enabled = false) // der test lässt sich momentan nicht validieren
  public void test_stellbadenhex() throws IOException
  {
    readCompare(IntelHexInputStream.class.getResource("/hexfiles/stellbaden.hex"), 16);
  }
  ...
  {
    readCompare(IntelHexInputStream.class.getResource("/hexfiles/stellbaden.eep"), 16);
  }

  @Test
  public void test_stellbadeneep_10() throws IOException
  {
    readCompare(IntelHexInputStream.class.getResource("/hexfiles/stellbaden.eep"), 10);
  }

  @Test
  public void test_stellbadeneep_1() throws IOException
  {
    readCompare(IntelHexInputStream.class.getResource("/hexfiles/stellbaden.eep"), 1);
  }

  @Test
  public void test_stellbadeneep_17() throws IOException
  {
    readCompare(IntelHexInputStream.class.getResource("/hexfiles/stellbaden.eep"), 17);
  }

  @Test
  public void test_stellbadeneep_4096() throws IOException
  {
    readCompare(IntelHexInputStream.class.getResource("/hexfiles/stellbaden.eep"), 4096);
  }
