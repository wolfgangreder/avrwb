 ...
 * @author wolfi
 */
public class StNGTest extends AbstractInstructionTest
{
  ...
  {
    final String cmd = "st " + ptr.name() + ",r" + rd + "\nnop\n.dw 0xffff";
    final int ptrAddrLo;
    switch (ptr) {
      case X:
        ptrAddrLo = 26;
  ...
  public void testSt4(XmlPart p,
                      ...
                      int cycles) throws Exception
  {
    final String cmd = "std " + ptr.name() + "+" + q + ",r" + rd + "\nnop\n.dw 0xffff";
    final int ptrAddrLo;
    switch (ptr) {
      case X:
        ptrAddrLo = 26;
