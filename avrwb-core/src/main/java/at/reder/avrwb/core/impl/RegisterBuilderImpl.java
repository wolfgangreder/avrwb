...
import at.reder.avrwb.core.Register;
import at.reder.avrwb.core.RegisterBit;
import at.reder.avrwb.core.RegisterBitBuilder;
import at.reder.avrwb.core.RegisterBuilder;
import java.util.ArrayList;
import java.util.List;
import java.util.Objects;

/**
 * Standardimplementierung für {@link at.reder.avrwb.core.RegisterBuilder}
 *
 * @see at.reder.avrwb.core.RegisterBuilder
...
public final class RegisterBuilderImpl implements RegisterBuilder
{
  ...
  private int mask = -1;
  private int size = -1;
  private final List<RegisterBit> registerBits = new ArrayList<>();
                                        ...
                                        RegisterVector vector) throws NullPointerException, IllegalArgumentException
  {
    ...
    Objects.requireNonNull(register, "cannot find register " + vector);
    ...
    RegisterBitBuilder builder = new RegisterBitBuilderImpl();
    for (XA_Bitfield bf : register.getBitfields()) {
      registerBits.add(builder.fromDescriptor(descriptorFile, vector, bf).build());
    }
    return this;
  }
  ...
  @Override
  public RegisterBuilder addRegisterBit(RegisterBit bit) throws NullPointerException
  {
