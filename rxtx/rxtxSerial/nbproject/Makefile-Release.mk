...
${OBJECTDIR}/_ext/7077a4e0/AwbCommDriver.o: /home/wolfi/projects/avrwb/rxtx/rxtxSerial/AwbCommDriver.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/java/latest/include -I/usr/java/latest/include/linux -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7077a4e0/AwbCommDriver.o /home/wolfi/projects/avrwb/rxtx/rxtxSerial/AwbCommDriver.cpp
...
${OBJECTDIR}/_ext/7077a4e0/RXTXPort.o: /home/wolfi/projects/avrwb/rxtx/rxtxSerial/RXTXPort.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/7077a4e0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/java/latest/include -I/usr/java/latest/include/linux -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7077a4e0/RXTXPort.o /home/wolfi/projects/avrwb/rxtx/rxtxSerial/RXTXPort.cpp
...
${OBJECTDIR}/SerialPeer.o: SerialPeer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/java/latest/include -I/usr/java/latest/include/linux -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SerialPeer.o SerialPeer.cpp
