...
/**
 * <p>Abstract ParallelPort class.</p>
 *
 * @author Trent Jarvi
 * @version %I%, %G%
 * @since JDK1.0
...
{
	/** Constant <code>LPT_MODE_ANY=0</code> */
	public static final int  LPT_MODE_ANY   =0;
	/** Constant <code>LPT_MODE_SPP=1</code> */
	public static final int  LPT_MODE_SPP   =1;
	/** Constant <code>LPT_MODE_PS2=2</code> */
	public static final int  LPT_MODE_PS2   =2;
	/** Constant <code>LPT_MODE_EPP=3</code> */
	public static final int  LPT_MODE_EPP   =3;
	/** Constant <code>LPT_MODE_ECP=4</code> */
	public static final int  LPT_MODE_ECP   =4;
	/** Constant <code>LPT_MODE_NIBBLE=5</code> */
	 ...
	 *
	 * @param lsnr a {@link gnu.io.ParallelPortEventListener} object.
