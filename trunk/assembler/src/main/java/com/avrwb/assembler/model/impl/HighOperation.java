 ...
 * @author wolfi
 */
public final class HighOperation extends AbstractFunctionExpression
{

  public HighOperation(Expression subExpression,
  ...
  {
    return (getSubExpression().evaluate(ctx) & 0xff00) >> 8;
  }
