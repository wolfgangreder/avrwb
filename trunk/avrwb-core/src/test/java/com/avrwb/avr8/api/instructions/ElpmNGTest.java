...
public class ElpmNGTest extends AbstractInstructionTest
{
  ...
  {
    return new Object[][]{
      {1, 0x00, 0x10, 0x00, 0x00, true, 0xf5, 3, 0x00, 0x00},
      {2, 0xff, 0x10, 0x20, 0x00, true, 0xc5, 3, 0x20, 0x00},
      {3, 0xff, 0x30, 0x20, 0x10, true, 0xcc, 3, 0x20, 0x10},
      {4, 0x00, 0xff, 0x00, 0x00, true, 0xf5, 3, 0x01, 0x00},
      {5, 0xff, 0xff, 0xff, 0x00, true, 0xc5, 3, 0x00, 0x01}
    };
  }
