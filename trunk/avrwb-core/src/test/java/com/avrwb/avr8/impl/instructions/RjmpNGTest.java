 ...
 * @author wolfi
 */
public class RjmpNGTest extends AbstractInstructionTest
{
  ...
  {
    return new Object[][]{
      {part, 0x1f0, 0x2f0, false, 2},
      {part, 0x80c, 0x00d, false, 2},
      {part, 0x1f0, 0x3f2, false, 2},
      {part, 0x10d, 0x90d, false, 2},
      {partmega22, 0x101f0, 0x102f0, false, 2},
      {partmega22, 0x2080c, 0x2000d, false, 2},
      {partmega22, 0x101f0, 0x103f2, false, 2},
      {partmega22, 0x2010d, 0x2090d, false, 2}
...
//      {partxmega22, 0x20ff0, 0xff, 3, false, 0x1f0, 4}
  ...
  public void testRjmp(XmlPart p,
                       int ip,
                       int expectedIp,
                       boolean list,
