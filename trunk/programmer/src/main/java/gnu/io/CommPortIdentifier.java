...

{
   ...
   * @param type a int.
   * @param c a {@link gnu.io.CommDriver} object.
   */
                                 ...
                                 CommDriver c)
  {
    ...
    AddIdentifierToList(new CommPortIdentifier(s,
                                               null,
                                               type,
                                               c));
  }
  ...
  /**
   * <p>
   * addPortOwnershipListener.</p>
   *
   * @param c a {@link gnu.io.CommPortOwnershipListener} object.
   */
   ...
   *
   * @param s a {@link java.lang.String} object.
   * @return a {@link gnu.io.CommPortIdentifier} object.
   * @throws gnu.io.NoSuchPortException if any.
   */
   ...
   * getPortIdentifier.</p>
   *
   * @param p a {@link gnu.io.CommPort} object.
   * @return a {@link gnu.io.CommPortIdentifier} object.
   * @throws gnu.io.NoSuchPortException if any.
   */
  ...
  /**
   * <p>
   * getPortIdentifiers.</p>
   *
   * @return a {@link java.util.Iterator} object.
   */
  static public Iterator<CommPortIdentifier> getPortIdentifiers()
  {
    if (debug) {
   ...
   * open.</p>
   *
   * @param f a {@link java.io.FileDescriptor} object.
   * @return a {@link gnu.io.CommPort} object.
   ...
   * open.</p>
   *
   * @param TheOwner a {@link java.lang.String} object.
   * @param i a int.
   * @return a {@link gnu.io.CommPort} object.
   * @throws gnu.io.PortInUseException if any.
   */
  public synchronized CommPort open(String TheOwner,
                                    int i)
          throws gnu.io.PortInUseException
  {
    ...
    if (commport == null) {
      commport = RXTXDriver.getCommPort(PortName,
                                        PortType);
    }
    if (commport != null) {
      Owner = TheOwner;
