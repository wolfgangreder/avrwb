...
final class LPRPort extends ParallelPort
{
  ...
  static {
    System.load(Utils.findNativeLibrary("rxtxParallel"));
    Initialize();
  }
 ...
 */
  ...
  public synchronized boolean sendEvent(int event,
                                        boolean state)
  /**
   * <p>
   * sendEvent.</p>
   ...
   */
  {
    ...
    ParallelPortEvent e = new ParallelPortEvent(this,
                                                event,
                                                !state,
                                                state);
   ...
   * {@inheritDoc}
   *
   * Note: these have to be separate boolean flags because the ParallelPortEvent constants are NOT bit-flags, they are just
