 ...
 * @author wolfi
 */
public final class Log2Operation extends AbstractFunctionExpression
{

  public Log2Operation(Expression subExpression,
  ...
  {
    return Integer.highestOneBit(getSubExpression().evaluate(ctx));
  }
