 ...
 * @author wolfi
 */
public final class UniMinusOperation extends AbstractUnaryExpression
{

  public UniMinusOperation(Expression subExpression,
  ...
  {
    return -getSubExpression().evaluate(ctx);
  }
