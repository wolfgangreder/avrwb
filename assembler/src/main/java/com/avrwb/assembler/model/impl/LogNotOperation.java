 ...
 * @author wolfi
 */
public final class LogNotOperation extends AbstractUnaryExpression
{

  public LogNotOperation(Expression subExpression,
  ...
  {
    return getSubExpression().evaluate(ctx) != 0 ? 0 : 1;
  }
